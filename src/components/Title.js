...
export default () => {
  return <div className='titlePage'>
    ...
    <h3>HOW TO PLAY</h3>
    <ul>
      <li>There are 4 different colored orbs in a specific order, guess what they are and what order they are in.</li>
      <li>Click and drag your colored orbs into the first row of bowls.</li>
      <li>Once you select your choice press the GO button to lock in that choice.</li>
      <li>If you have a matching color and position the computer will respond with a red tag. </li>
